...
// Dev-only raw OTP retrieval for local automated tests. Explicitly opt-in and require an admin key.
router.get('/debug/raw-otp', sensitiveLimiter, userController.debugGetRawOtpController);
