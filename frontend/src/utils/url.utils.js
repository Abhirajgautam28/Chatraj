...
/**
 * Extract YouTube Video ID and return a safe embed URL.
 * @param {string} urlString
 * @returns {string} Safe embed URL or empty string
 */
...
/**
 * Validates that a URL is safe.
 * Allows http/https absolute URLs and safe relative paths.
 * @param {string} urlString
 * @returns {boolean}
 */
