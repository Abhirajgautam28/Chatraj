...
`}
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {features.map((feature, index) => (
              <motion.div
                ...
                className={`p-6 transition-all duration-300 border rounded-xl shadow-lg backdrop-blur-xl ${isDarkMode ? 'bg-white/[0.05] border-white/10 shadow-[0_4px_24px_-1px_rgba(0,0,0,0.5)]' : 'bg-white/[0.15] border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.2)]'} rounded-[2.5rem] transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:border-blue-400/50`}
              >
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`flex gap-4 p-6 transition-all duration-300 border rounded-xl shadow-lg backdrop-blur-xl ${isDarkMode ? 'bg-white/[0.05] border-white/10 shadow-[0_4px_24px_-1px_rgba(0,0,0,0.5)]' : 'bg-white/[0.15] border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.2)]'} rounded-[2.5rem] transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:border-blue-400/50`}
              >
      ...
      <section className="relative py-20 z-10 px-4">
        <div className={`max-w-4xl mx-auto p-8 border rounded-2xl shadow-xl backdrop-blur-xl ${isDarkMode ? 'bg-white/[0.05] border-white/10 shadow-[0_4px_24px_-1px_rgba(0,0,0,0.5)]' : 'bg-white/[0.15] border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.2)]'} rounded-[2.5rem] transition-all duration-500`}>
