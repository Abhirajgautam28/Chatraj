                ...
                <div className="relative flex flex-col flex-grow h-full pb-10 conversation-area pt-14">
                    ...
                    <div
                        ...
                        {messages.map((msg, index) => (
                            <div key={index} className={`${msg.sender._id === 'Chatraj' ? 'max-w-80' : 'max-w-52'} ${msg.sender._id == user._id.toString() && 'ml-auto'}  message flex flex-col p-2 bg-slate-50 w-fit rounded-md`}>
                                <small className='text-xs opacity-65'>{msg.sender.email}</small>
                                <div className='text-sm'>
                                    {msg.sender._id === 'Chatraj' ?
