  ...
  >
    ...
    <div className="flex-1 flex flex-col p-5">
      ...
      <div className="flex items-center gap-2 mt-auto">
        ...
        <span className="text-gray-500 dark:text-gray-300 text-xs">{blog.authorName || (blog.author ? `${blog.author.firstName} ${blog.author.lastName}` : 'Unknown Author')}</span>
