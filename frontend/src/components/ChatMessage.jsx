...
const ChatMessage = React.memo(({
  ...
  getUserBubbleStyle,
  renderMessage, // Fallback if needed, but we prefer internal logic
  toggleEmojiPicker,
  messageEmojiPickers,
  handleReaction,
  setReplyingTo,
                          ...
                          return (
                            <div className="relative group/code">
                              <button
                                ...
                                className="absolute top-2 right-2 p-1.5 rounded bg-slate-800 hover:bg-slate-700 text-white opacity-0 group-hover/code:opacity-100 transition-opacity z-20"
                                title="Copy code"
                              >
